...
lieferten denselben 403-Fehler — vermutlich blockiert die Netzwerk-Policy dieser
Cloud-Sandbox ausgehende Verbindungen zu beiden Domains. Keine Termine erfunden; ob Di 18.08.
...
Gestrige Daily Range (2026-08-14, letzter verfügbarer Handelstag — Markt war zum Laufzeitpunkt
noch offen, daher kein frischerer Tag verfügbar): High 30283.00 / Low 30028.50 / Close 30154.00.

Weekly Range: keine Daten für die laufende ISO-Woche 34 vorhanden — Zeile entfällt statt eine
Zahl zu erfinden.

ORG-C.E.: `algo/live_status.py` meldete `market_data: false` (Markt zum Laufzeitpunkt offen,
aber kein 5m-Feed/IBKR-Gateway erreichbar) — Zeile entfällt ohne Platzhalter.

**Datenlage:** 2 Tage 1s (13., 14.08.), 12 Tage nur 1m im betrachteten Zeitraum
(2026-07-14 – 2026-08-18). Keine `registriert_ohne_datei`-Lücken. 1s-vs-1m-Abgleich für beide
...
Dienstag zeigt in `algo/seasonal_tendency.json` (n=380, 2019–2026) keine belastbare
Richtungstendenz: 50.5% bullische Tage, avg_return_pct 0.056%, avg_range ~304.6 Punkte —
praktisch Münzwurf, kein statistischer Edge allein aus dem Wochentag.
...
primäres Ziel für die Di-Range.
...
nicht bestätigt. Für 2026-08-18 lässt sie sich vorab naturgemäß nicht auswerten, da das ORG erst
mit der US-Session-Eröffnung entsteht.

Da der News-Abruf fehlgeschlagen ist (siehe oben), bleibt unklar, ob am Dienstag ein
