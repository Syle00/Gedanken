...
auf **2,75 Handle** genau.

## Daily Low: zwei unabhängige Projektionen kombinieren

1. **Vortages-Range** (Low bis High des Vortags) als Fib gemessen, **negative Extension** darunter
   projiziert.
2. **Wick-Range von vor 3 Tagen** (Referenzpunkt für den [[IPDA Data Ranges|3-Tage-Intraday-Lookback]])
   separat als Fib gemessen, ebenfalls negative Extension.
3. **Stimmen beide Projektionen überein** (im Beispiel je ca. 28.070–28.124), gilt die Zone
   dazwischen bzw. ihr Consequent-Encroachment-Mittelpunkt als **High-Probability-Draw** für den
   Daily Low.

## Fulcrum Point (dritte Projektionsmethode)

Bei einem Climax-Reversal-High: die Fib von diesem Hoch zum vorangehenden Tief spannen. Der Tiefpunkt
wirkt als **Scharnierpunkt (Fulcrum)** — der vorangegangene Rally-Leg wird gedanklich wie eine Tür um
...
> Ein Daily High/Low bildet sich innerhalb einer **Clusterung mehrerer PD Arrays**, nicht an einem
> einzelnen, isolierten Level. Mehrere unabhängige Messungen (Vortag, 3-Tage-Wick, Pre-Market-Range)
> müssen zusammen betrachtet werden.

Ergänzt die bestehende [[PD Array#3 Komponenten einer starken PD (Kurz Notizen)|3-Komponenten-Regel]]
um eine konkrete Rechenvorschrift für Tages-Extremwerte.
